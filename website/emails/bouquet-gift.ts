...
export function textFor({ url, to, from }: GiftEmail) {
...
export function htmlFor({ url, imageUrl, from }: GiftEmail) {
  return `<!doctype html>
...
<tr><td style="padding:28px 32px 8px">
  <a href="${escape(url)}" style="text-decoration:none"><img src="${escape(imageUrl)}" width="496" alt="A sealed gift. Open your gift to see what is inside." style="display:block;border:0;width:100%;max-width:496px;border-radius:18px"></a>
</td></tr>
