...
export const metadata: Metadata = {
  ...
  openGraph: openGraph({ title: "Free Photo Booth | Dayflower", description: "Solo moments. Two-person keepsakes. Make a photo strip for free, without an account.", path: "/photobooth", image: null }),
};
const faqs = [
