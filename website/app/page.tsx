...
const tools = [
  ...
  { number: "02", name: "Photo booth", label: "Make a memory you can keep.", description: "Turn your favorite photos into a scrapbook, collage, postcard, or photo strip. Eight layouts, ready to download.", href: "/photobooth", action: "Open the booth", note: "Free · no account needed", className: "is-booth" },
  ...
  return <><SiteHeader /><main id="top" className="dayflower-home">
    <section className="home-hero">
      <div className="home-hero-copy"><p className="home-eyebrow">LITTLE THINGS. MEANINGFUL CONNECTIONS.</p>
        ...
        <p>A digital bouquet, sent with love. A photo worth keeping. A small reminder that they’re on your mind. Find a little way to show up for someone you love.</p>
      ...
      <div className="home-letter"><p className="home-letter-to note">For your favorite person.</p><Image src="/bouquet/reveal-envelope-hero.webp" alt="An ivory envelope sealed with a burgundy heart and a sprig of flowers" width={512} height={432} priority className="home-letter-art" /><p className="home-letter-note">A little something can mean everything.</p><span className="home-letter-signature">with love, Dayflower</span></div>
    </section>
