// Review-only navigation. Not imported by production code.
...
class ChatReviewNav extends ConsumerWidget {
  const ChatReviewNav({super.key});
            ...
            children: [
              ...
              Expanded(
                  child: Semantics(
                      ...
                      button: true,
                      child: Tooltip(
                          message: 'Send flowers',
                          child: InkWell(
                            borderRadius: BorderRadius.circular(AppRadius.md),
                            onTap: () =>
                                context.go('${Routes.chat}?compose=flowers'),
                            child: SizedBox(
                                height: 52,
                                child: Center(
                                    child: ClipRRect(
              ...
              _NavItem(
                ...
                label: 'Memories',
                selected: location.startsWith('/app/memories'),
                onTap: () => context.go('/app/memories'),
              ),
              _NavItem(
                icon: CupertinoIcons.square_grid_2x2_fill,
                label: 'Together',
                selected: location.startsWith('/app/together'),
                onTap: () => context.go('/app/together'),
              ),
            ],
          ),
        ),
