...
export '../../data/booth_photo_picker.dart';
...
class _BoothArchiveScreenState extends ConsumerState<BoothArchiveScreen> {
  bool _duo = true;
  bool _busy = false;
  Uint8List? _photo;
  String? _error;
            ...
            child: _photo == null
                ? Center(
                    child: Text('Add your photo to get started',
                        style:
                            AppText.body((_joining?.style ?? _template).ink)))
                : Image.memory(_photo!,
